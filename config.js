...
const baseConfig = {
  ...
  BOT_INFO: process.env.BOT_INFO || "LEO.PY;default",
  RBG_KEY: process.env.RBG_KEY || "",
  ALLOWED: process.env.ALLOWED || "91,94,2",
  NOT_ALLOWED: process.env.NOT_ALLOWED || "852",
  CHATBOT: process.env.CHATBOT || "off",
  HANDLERS: process.env.HANDLERS || ".,",
  STICKER_DATA: process.env.STICKER_DATA || "LEO.PY",
  BOT_NAME: process.env.BOT_NAME || "LEO.PY",
  AUDIO_DATA:
  ...
  SUPPORT_GROUP: process.env.SUPPORT_GROUP || "NULL",
