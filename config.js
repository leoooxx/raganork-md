...
const baseConfig = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝕷𝕰𝕺™BOT;LEONARDO;default',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.NOT_ALLOWED || '852',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || " 𝕷𝕰𝕺™BOT",
    BOT_NAME: process.env.BOT_NAME || ' 𝕷𝕰𝕺™BOT',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝕷𝕰𝕺.py™️ꫂ; 𝕷𝕰𝕺™BOT MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
